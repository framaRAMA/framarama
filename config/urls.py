...
urlpatterns = [
    ...
    path('frames/<int:frame_id>/finishings/import', frame.ImportFinishingFrameView.as_view(), name='frame_finishing_import'),
    path('frames/<int:frame_id>/finishings/edit', frame.RawEditFinishingFrameView.as_view(), name='frame_finishing_rawedit'),
